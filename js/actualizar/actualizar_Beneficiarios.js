$(document).ready(function () {
    ...
    $('#form_Beneficiarios input, #form_Beneficiarios select').prop('disabled', true);

    // Activar los campos al hacer clic en "Modificar"
    $('#btn_editar').on('click', function () {
        $('#form_Beneficiarios input, #form_Beneficiarios select').prop('disabled', false);
    ...
    $('#form_Beneficiarios').on('submit', function (e) {
        ...
        $.ajax({
            url: '../../modulos/actualizar/actualizar_beneficiarios.php', // Ajusta esta ruta
            type: 'POST',
            data: $(this).serialize(),
