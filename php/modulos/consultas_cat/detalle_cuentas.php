    ...
    <div class="card mt-3 border shadow rounded-0">
        <form id="form_Cuentas" method="POST">
            <div class="card-header formulario_clientes">
                ...
                <div class="row">
                    <div class="col-10 col-sm-1 mt-4">
                        ...
                        <input id="id" name="id" type="text"
                            ...
                            style="background-color: transparent;" value="<?php echo $cuenta['Id']; ?>"
                            readonly>
                    </div>
                    ...
                    <div class="col-10 col-sm-2 mt-4">
                        <label for="empresa" class="form-label text-muted small">TIPO :</label>
                        <input id="empresa" name="empresa" type="text"
                            class="form-control input-transparent border-0 border-bottom rounded-0"
                            style="background-color: transparent;" value="<?php 
                            if($cuenta['TipoSaldo'] == 1){
                                echo 'ACREEDOR'; 
                            }else{
                                echo 'DEUDOR';
                            }
                ...
                <div class="row">
                    <div class="col-10 col-sm-4 mt-4">
                        <label for="nombre" class="form-label text-muted small">USUARIO ALTA :</label>
                        <input id="nombre" name="nombre" type="text"
                            class="form-control input-transparent border-0 border-bottom rounded-0"
                    ...
                    <div class="col-10 col-sm-4 mt-4">
                        <label for="nombre" class="form-label text-muted small">FECHA ALTA :</label>
                        <input id="nombre" name="nombre" type="text"
                            class="form-control input-transparent border-0 border-bottom rounded-0"
                            style="background-color: transparent;" value="<?php echo $cuenta['FechaAlta']; ?>"
                            readonly>
                    </div>
                </div>
