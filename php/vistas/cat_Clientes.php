            ...
            <div class="card-header">
                <div class="d-flex flex-column mb-3">
                    <div class="row w-100">
                        ...
                        <div class="col-12 col-sm-2 d-flex align-items-center justify-content-start justify-content-sm-end mt-2 mt-sm-0">
                            <a href="clientes_agregar.php" style="text-decoration: none; color: black;"><h6><i class="fas fa-plus mt-2"></i></h6></a>
                ...
                <table  class="table table-hover">
                    ...
                    <tbody class="small">
                        ...
                        <td>1</td>
                        <td>BIRLOS AUTOMOTRICES HERCULES, S.A DE C.V.</td>
                        <td></td>
                        <td></td>
                        <td></td>
                        </tr>
                        ...
                        <td>2</td>
                        <td>RITCHIE BROS AUCTIONEERS DE MEXICO, S. DE R.L. DE C .V.</td>
                        <td></td>
                        <td></td>
                        <td></td>
                        </tr>
                        ...
                        <td>3</td>
                        <td>SIEGWERK MEXICO, SA DE CV.</td>
                        <td></td>
                        <td>MEXICO</td>
                        <td>MEXICO</td>
                        </tr>
