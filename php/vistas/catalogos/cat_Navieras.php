    ...
    <div class="card mt-3 border shadow rounded-0">
        <div class="card-header">
            <div class="d-flex flex-column mb-3">
                <div class="row w-100">
                    <h5 class="mt-4 mb-1">
                        <i class="fas fa-anchor me-2 text-secondary"></i> Catálogo Navieras
                    </h5>
                    <div class="col-12 col-sm-10 d-flex align-items-center">
                        <input id="filtroInput" type="text" class="form-control w-100 rounded-0 border-0 border-bottom"
                            style="background-color: transparent;" placeholder="Filtrar naviera por nombre"
                    ...
                    <div
                        ...
                        <?php if (isset($_SESSION['departamento']) && $_SESSION['departamento'] == 1): ?>
                            <a href="../formularios/form_navieras.php" data-bs-toggle="tooltip" data-bs-placement="top"
...
<script src="../../../js/desactivar_Navieras.js"></script>
