        ...
        <div class="card mt-3 border shadow rounded-0">
            <div class="card-header">
                <div class="d-flex flex-column mb-3">
                    <div class="row w-100">
                        <h5 class="mt-4 mb-1">
                            <i class="fas fa-building me-2 text-secondary"></i> Catálogo Recintos
                        </h5>
                        <div class="col-12 col-sm-10 d-flex align-items-center">
                            <input id="filtroInput" type="text" class="form-control w-100 rounded-0 border-0 border-bottom" style="background-color: transparent;" placeholder="Filtrar recinto por nombre" aria-label="Filtrar por fecha" aria-describedby="basic-addon1">
                        </div>
                        <div class="col-12 col-sm-2 d-flex align-items-center justify-content-start justify-content-sm-end mt-2 mt-sm-0">
                            ...
                            <a href="/portal_web/Contabilidad/php/vistas/formularios/form_recintos.php" style="text-decoration: none; color: black;"><h6><i class="fas fa-plus mt-2"></i></h6></a>
                ...
                <div id="tabla-recintos-container">
                    <?php include('../../modulos/consultas_cat/tabla_recintos.php'); ?>
                </div>
...
<script>
  ...
  document.getElementById("filtroInput").addEventListener("input", function () {
    ...
    xhr.open("GET", "../../modulos/consultas_cat/tabla_recintos.php?filtro=" + encodeURIComponent(filtro), true);
    xhr.onload = function () {
        if (this.status === 200) {
            document.getElementById("tabla-recintos-container").innerHTML = this.responseText;
        }
    };
    xhr.send();
    });
</script>
<script src="../../../js/desactivar_Recintos.js"></script>
