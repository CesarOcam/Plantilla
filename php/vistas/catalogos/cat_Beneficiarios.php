    ...
    <div class="container-fluid">
        <div class="card mt-3 border shadow rounded-0">
            <div class="card-header">
                <div class="d-flex flex-column mb-3">
                    <div class="row w-100">
                        <div class="col-12 col-sm-10 d-flex align-items-center">
                            <input type="text" class="form-control w-100 rounded-0 border-0 border-bottom" style="background-color: transparent;" placeholder="Filtrar beneficiario por nombre" aria-label="Filtrar por fecha" aria-describedby="basic-addon1">
                        </div>
                ...
                <?php
                    include('../../modulos/consultas_cat/tabla_beneficiarios.php');
                ?>
            </div>
