                ...
                <div class="d-flex flex-column mb-3">
                    <div class="row w-100">
                        ...
                        <div class="col-12 col-sm-2 d-flex align-items-center justify-content-start justify-content-sm-end mt-2 mt-sm-0">
                            ...
                            <a href="/portal_web/Contabilidad/php/vistas/formularios/form_beneficiarios.php" style="text-decoration: none; color: black;"><h6><i class="fas fa-plus mt-2"></i></h6></a>
