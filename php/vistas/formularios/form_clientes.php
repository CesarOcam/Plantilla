            ...
            <div class="card-header formulario_clientes">
                ...
                <div class="row">
                    ...
                    <div class="col-10 col-sm-4 d-flex align-items-center mt-4">
                        <input name="nombre" type="text" class="form-control rounded-0 border-0 border-bottom"
                            style="background-color: transparent;" placeholder="Nombre/Razón Social*"
                ...
                <div class="row">
                    <div class="col-2 col-sm-6 d-flex align-items-center mt-4">
                        <input name="nombre_corto" type="text" class="form-control rounded-0 border-0 border-bottom"
                            style="background-color: transparent;" placeholder="Nombre Conocido"
                            aria-label="Filtrar por fecha" aria-describedby="basic-addon1">
                    </div>
                    <div class="col-2 col-sm-3 d-flex align-items-center mt-4">
                        <input name="contacto_cliente" type="text" class="form-control rounded-0 border-0 border-bottom"
                            style="background-color: transparent;" placeholder="Contacto" aria-label="Filtrar por fecha"
                            aria-describedby="basic-addon1">
                    </div>
                    <div class="col-2 col-sm-3 d-flex align-items-center mt-4">
                        <input name="telefono_cliente" type="text" class="form-control rounded-0 border-0 border-bottom"
                            style="background-color: transparent;" placeholder="Teléfono" aria-label="Filtrar por fecha"
                            aria-describedby="basic-addon1">
                    </div>
                </div>
                <div class="row">
                    <div class="col-2 col-sm-3 d-flex align-items-center mt-4">
                        <input name="calle" type="text" class="form-control rounded-0 border-0 border-bottom"
                            style="background-color: transparent;" placeholder="Calle" aria-label="Filtrar por fecha"
                            aria-describedby="basic-addon1">
                    </div>
                    <div class="col-10 col-sm-1 d-flex align-items-center  mt-4">
                        <input name="num_exterior" type="text" class="form-control rounded-0 border-0 border-bottom"
                            style="background-color: transparent;" placeholder="Número Exterior"
                            aria-label="Filtrar por fecha" aria-describedby="basic-addon1">
                    </div>
                    <div class="col-10 col-sm-1 d-flex align-items-center mt-4">
                        <input name="num_interior" type="text" class="form-control rounded-0 border-0 border-bottom"
                            style="background-color: transparent;" placeholder="Número Interior"
                            aria-label="Filtrar por fecha" aria-describedby="basic-addon1">
                    </div>
                    <div class="col-10 col-sm-1 d-flex align-items-center mt-4">
                        <input name="cp" type="text" class="form-control rounded-0 border-0 border-bottom"
                            style="background-color: transparent;" placeholder="Código Postal"
                            aria-label="Filtrar por fecha" aria-describedby="basic-addon1">
                    </div>
                    <div class="col-2 col-sm-3 d-flex align-items-center mt-4">
                        <input name="colonia" type="text" class="form-control rounded-0 border-0 border-bottom"
                            style="background-color: transparent;" placeholder="Colonia" aria-label="Filtrar por fecha"
                            aria-describedby="basic-addon1">
                    </div>
                    <div class="col-10 col-sm-3 d-flex align-items-center  mt-4">
                        <input name="localidad" type="text" class="form-control rounded-0 border-0 border-bottom"
                            style="background-color: transparent;" placeholder="Localidad"
                            aria-label="Filtrar por fecha" aria-describedby="basic-addon1">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-2 col-sm-4 d-flex align-items-center mt-4">
                        <input name="municipio" type="text" class="form-control rounded-0 border-0 border-bottom"
                            style="background-color: transparent;" placeholder="Municipio"
                            aria-label="Filtrar por fecha" aria-describedby="basic-addon1">
                    </div>
                    <div class="col-2 col-sm-4 d-flex align-items-center mt-4">
                        ...
                        <div class="row w-100 mt-2 mb-3">
                            ...
                            <div class="col-sm-12 d-flex align-items-center mt-2"
                                ...
                                <div class="form-check me-4" style="background-color: transparent;">
                                    <input class="form-check-input" type="radio" name="pagaCon_cliente"
                                        id="cuenta_cliente" value="1" required>
                                    <label class="form-check-label" for="cuenta_cliente"
                                        style="background-color: transparent;">
                                        Cuenta Cliente
                                    </label>
                                </div>
                                <div class="form-check" style="background-color: transparent;">
                                    <input class="form-check-input" type="radio" name="pagaCon_cliente"
                                        id="cuenta_amexport" value="2">
                                    <label class="form-check-label" for="cuenta_amexport"
                                        style="background-color: transparent;">
                                        Cuenta Amexport
                                    </label>
                                </div>
                ...
                <div class="row">
                    <div class="col-2 col-sm-4 d-flex align-items-center mt-4 mb-3">
                        <select id="logistico_asociado-select" name="logistico_asociado"
                            class="form-control rounded-0 border-0 border-bottom text-muted"
                            style="background-color: transparent;" aria-label="Filtrar por fecha"
                            aria-describedby="basic-addon1">
                    ...
                    <div class="col-2 col-sm-4 d-flex align-items-center mt-4 mb-3">
                        <input name="emails_trafico" type="text" class="form-control rounded-0 border-0 border-bottom"
                            style="background-color: transparent;" placeholder="E-Mails de Logístico"
                            aria-label="Filtrar por fecha" aria-describedby="basic-addon1">
                    </div>
                    <div class="col-2 col-sm-4 d-flex align-items-center mt-4 mb-3">
                        <label class="form-label me-3 text-muted mb-0"
                            style="background-color: transparent;">Estado:</label>
                        <div class="form-check form-check-inline" style="background-color: transparent;">
                            <input class="form-check-input" type="radio" name="status_exportador" id="estado_activo"
                                value="1" required>
                            <label class="form-check-label" for="estado_activo"
                                style="background-color: transparent;">Activo</label>
                        </div>
                        <div class="form-check form-check-inline" style="background-color: transparent;">
                            <input class="form-check-input" type="radio" name="status_exportador" id="estado_inactivo"
                                value="0">
                            <label class="form-check-label" for="estado_inactivo"
                                style="background-color: transparent;">Inactivo</label>
                        </div>
                    </div>
                </div>
