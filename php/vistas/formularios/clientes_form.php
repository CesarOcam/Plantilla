            ...
            <form id="form_Clientes" method="POST">
                <div class="card-header formulario_clientes">
                    <div class="row">
                            ...
                            <div class="col-10 col-sm-2 d-flex align-items-center mt-4">
                                <select name="tipo" class="form-control rounded-0 border-0 border-bottom" style="background-color: transparent;" aria-label="Filtrar por fecha" aria-describedby="basic-addon1">
                        ...
                        <div class="row">
                            <div class="col-2 col-sm-12 d-flex align-items-center mt-4">
                                <input name="referencia" type="text" class="form-control rounded-0 border-0 border-bottom" style="background-color: transparent;" placeholder="Referencia" aria-label="Filtrar por fecha" aria-describedby="basic-addon1">
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-2 col-sm-3 d-flex align-items-center mt-4">
                                <input name="estado" type="text" class="form-control rounded-0 border-0 border-bottom" style="background-color: transparent;" placeholder="Estado" aria-label="Filtrar por fecha" aria-describedby="basic-addon1">
                            </div>
                            <div class="col-2 col-sm-3 d-flex align-items-center mt-4">
                                <input name="pais" type="text" class="form-control rounded-0 border-0 border-bottom" style="background-color: transparent;" placeholder="País" aria-label="Filtrar por fecha" aria-describedby="basic-addon1">
                            </div>
                            <div class="col-2 col-sm-3 d-flex align-items-center mt-4">
                        ...
                        <div class="row">
                            <div class="col-2 col-sm-6 d-flex align-items-center mt-4 mb-3">
                                <input name="email_trafico" type="text" class="form-control rounded-0 border-0 border-bottom" style="background-color: transparent;" placeholder="E-Mails de Tráfico" aria-label="Filtrar por fecha" aria-describedby="basic-addon1">
                            </div>
                            <div class="col-2 col-sm-6 d-flex align-items-center mt-4 mb-3">
                                <input name="email_conta" type="text" class="form-control rounded-0 border-0 border-bottom" style="background-color: transparent;" placeholder="E-Mails de Contabilidad" aria-label="Filtrar por fecha" aria-describedby="basic-addon1">
                            </div>
                        </div>
